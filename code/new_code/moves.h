...
void setWalkingPosition(Robot *Hexapod, int delay_time)
{
    ...
    evaluateLegPositionRobotCenter(Hexapod, LEFT_FRONT, -220, 150, z_const_zero);
    delay(delay_time);
    evaluateLegPositionRobotCenter(Hexapod, LEFT_MIDDLE, -250, 40, z_const_zero);
    delay(delay_time);
    evaluateLegPositionRobotCenter(Hexapod, LEFT_BACK, -210, -260, z_const_zero);
    delay(delay_time);
    evaluateLegPositionRobotCenter(Hexapod, RIGHT_FRONT, 220, 230, z_const_zero);
    delay(delay_time);
    evaluateLegPositionRobotCenter(Hexapod, RIGHT_MIDDLE, 250, -40, z_const_zero);
    delay(delay_time);
    evaluateLegPositionRobotCenter(Hexapod, RIGHT_BACK, 210, -200, z_const_zero);
    delay(delay_time);
    ...
    // evaluateLegPositionRobotCenter(Hexapod, LEFT_FRONT, -x_const, 163.25 , z_const_zero);
    // delay(delay_time);
    // evaluateLegPositionRobotCenter(Hexapod, LEFT_MIDDLE, -x_const,0, z_const_zero);
    // delay(delay_time);
    // evaluateLegPositionRobotCenter(Hexapod, LEFT_BACK, -x_const, -163.25 , z_const_zero);
    // delay(delay_time);
    ...
    // delay(delay_time);
    // evaluateLegPositionRobotCenter(Hexapod, RIGHT_BACK, x_const, -163.25 , z_const_zero);
    // delay(delay_time);
