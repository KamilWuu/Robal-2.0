...
void SetTransportPosition(int delay_time)
{
    ...
    SetServoAngle(pca_right, RIGHT_BACK_Q2, zero_angle + 15 + Q2_angle_variable);
    SetServoAngle(pca_left, LEFT_BACK_Q2, zero_angle - Q2_angle_variable);
    printf("Q2_BACK\n");
    delay(delay_time);

    SetServoAngle(pca_right, RIGHT_MIDDLE_Q2, zero_angle + 15 + Q2_angle_variable);
    SetServoAngle(pca_left, LEFT_MIDDLE_Q2, zero_angle - Q2_angle_variable);
    printf("Q2_MIDDLE\n");
    delay(delay_time);

    SetServoAngle(pca_right, RIGHT_FRONT_Q2, zero_angle + 15 + Q2_angle_variable);
